...
public class ModeDuel extends Mode {
    ...
    public ModeDuel() {
        ...
        // Saisie des combinaisons que l'ordi doit deviner
        ...
        // Saisie des combinaisons que le joueur doit deviner
        combinaisonToFind = new CombinaisonAleatoire(settings);
    }

    @Override
    public void play() {
        // Tentative de deviner Pour le joueur
        System.out.println("");
        ...
        // Tentative de deviner Pour l'ordi
        System.out.println("");
